...
export const projects: Project[] = [
  ...
  {
    id: 'Machine Vision Development Using AI Edge Computing (Delta Arm)',
    order: '04',
    type: { th: 'โปรเจคจบ', en: 'Final Year Project' },
    title: { th: 'โปรเจกต์ใหม่ 1', en: 'New Project 1' },
    description: { th: 'ใส่คำอธิบายโปรเจกต์ที่นี่', en: 'Add the project description here.' },
    role: { th: 'ใส่บทบาทของคุณที่นี่', en: 'Add your role here' },
    technologies: ['Technology 1', 'Technology 2'],
    challenge: { th: 'ใส่รายละเอียดโจทย์ของโปรเจกต์ที่นี่', en: 'Add the project challenge here.' },
    result: { th: 'ใส่ผลลัพธ์ของโปรเจกต์ที่นี่', en: 'Add the project result here.' },
    liveUrl: '#',
    githubUrl: '#',
    media: [
  ...
  },
  {
    id: 'project-05',
    order: '05',
    type: { th: 'ประเภทโปรเจกต์', en: 'Project Type' },
    title: { th: 'โปรเจกต์ใหม่ 2', en: 'New Project 2' },
    description: { th: 'ใส่คำอธิบายโปรเจกต์ที่นี่', en: 'Add the project description here.' },
    role: { th: 'ใส่บทบาทของคุณที่นี่', en: 'Add your role here' },
    technologies: ['Technology 1', 'Technology 2'],
    challenge: { th: 'ใส่รายละเอียดโจทย์ของโปรเจกต์ที่นี่', en: 'Add the project challenge here.' },
    ...
    githubUrl: '#',
    media: [
      { src: '/projects/project-05-1.jpg', fallbackColor: '#5B8DEF' },
      { src: '/projects/project-05-2.jpg', fallbackColor: '#8B7CF6' },
      { src: '/projects/project-05-3.jpg', fallbackColor: '#F2A25C' },
      { src: '/projects/project-05-4.jpg', fallbackColor: '#F2748C' },
    ],
  },
]
